# -*- coding: utf-8 -*-
"""
Created on Mon Sep 18 13:49:08 2023
...
token_patterns = [
    ...
    (r';', 3),                                 # ; (punto y coma)
    (r',', 4),                                 # , (coma)
    (r'\(', 5),                                # ( (parentesis izquierdo)
    (r'\)', 6),                                # ) (parentesis derecho)
...
# Función para analizar una cadena y para encontrar los tokens y errores 
...
# el espacio es marcado como un error
...
# mostrar el resultado de los tokens
    ...
    if errores:
        ...
        for error in errores:
            print(f"Error: Caracter '{error}' no reconocido.")
